ecc.grid.Default = function(config) {
    config = config || {};
    ...
    ecc.grid.Default.superclass.constructor.call(this, config);
};
Ext.extend(ecc.grid.Default, MODx.grid.Grid, {
    windows: {},
...
Ext.reg('ecc-grid-default', ecc.grid.Default);